...
namespace Felismero_motor
{
    class dtwApp_match
    {
        ...
        private static int num_of_vectoritems = H_FELDOLGOZO.mfcc_lpc_vect_num;
        ...
        private String distanceType = "Euclidean";  //Itakura, Euclidean
        ...
        public double[] GetReferenceVector(int frame)
        {
            ...
            double[] temp_ref = new double[H_FELDOLGOZO.mfcc_lpc_vect_num];
        ...
        public bool lefttorightMatch()
        {
            ...
            double[] temp1 = new double[H_FELDOLGOZO.mfcc_lpc_vect_num];
            double[] temp2 = new double[H_FELDOLGOZO.mfcc_lpc_vect_num];
                  ...
                  int testlength, int reflength)
        {
            ...
            //pathRecord[templateIndex,0] = temppath;  //  FIX IT CODE x01
            ...
            //for (int iter = 0; iter < temppath.Length - 1; iter++)
            //{
            //    pathRecord[templateIndex, iter] = temppath[iter];
            //}
