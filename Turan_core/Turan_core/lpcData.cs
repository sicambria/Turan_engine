...
namespace Turan_core
{
    public class lpcData
    {
        ...
        private static int num_of_mfcc_lpc_vectors = Engine.mfcc_lpc_vect_num;

        //skip header in plaintext (special format) LPC - don't change, unless you change file format that contains vectors
        ...
        public int getRowLength()
        {
            //return length;
            //return data.Length;
            return data.Length / Engine.mfcc_lpc_vect_num;
        }
